...
@section('content')
    ...
    <div class="service-form-wrap">
        <div class="service-form-head">
            ...
            <p>Add a polished service entry with a clear title, category, description, and icon for the homepage service section.</p>
        </div>
                ...
                <div class="service-form-grid">
                    <div class="service-section-card">
                        ...
                        <div class="service-field">
                            ...
                            <input id="service-title" type="text" name="title" value="{{ old('title') }}" maxlength="255" placeholder="e.g. Network Infrastructure" required>
                        ...
                        <div class="service-field">
                            ...
                            <textarea id="service-description" name="description" rows="8" placeholder="Describe what the service includes, outcomes, and value to clients..." required>{{ old('description') }}</textarea>
                    ...
                    <div class="service-section-card">
                        ...
                        <div class="service-field">
                            ...
                            <input id="service-icon" type="text" name="icon" value="{{ old('icon') }}" placeholder="fa-code, fa-mobile-alt, fa-cogs, fa-star">
