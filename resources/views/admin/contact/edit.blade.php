...
@section('content')
    ...
    <div class="contact-form-wrap">
        <div class="contact-form-head">
            <h2>Edit Contact</h2>
            <p>Update this contact item to keep your public contact information accurate and easy to understand.</p>
        </div>
                ...
                <div class="contact-form-grid">
                    <div class="contact-section-card">
                        ...
                        <div class="contact-field">
                            ...
                            <input id="contact-label" type="text" name="label" value="{{ old('label', $contact->label) }}" maxlength="255" placeholder="e.g. Customer Support" required>
                        ...
                        <div class="contact-field">
                            ...
                            <input id="contact-value" type="text" name="value" value="{{ old('value', $contact->value) }}" maxlength="255" placeholder="e.g. info@example.com" required>
