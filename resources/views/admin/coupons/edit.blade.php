...
@section('content')
    ...
    <div class="coupon-page">
        <div class="coupon-head">
            <h2>Edit Coupon</h2>
            <p>Update discount rules and validity windows while keeping your promotion settings clear and safe.</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.coupons.update', $coupon) }}">
                ...
                <div class="coupon-grid">
                    <section class="coupon-card">
                        ...
                        <p class="coupon-sub">Adjust value, order limits, activity status, and timeline.</p>
                    ...
                    <aside class="coupon-card coupon-preview-panel">
                        ...
                        <div class="coupon-preview">
                            <span id="coupon-status-preview" class="coupon-status {{ old('is_active', $coupon->is_active ?? true) ? 'active' : 'inactive' }}">{{ old('is_active', $coupon->is_active ?? true) ? 'Active' : 'Inactive' }}</span>
                            <div id="coupon-code-preview" class="coupon-preview-code">{{ strtoupper(old('code', $coupon->code ?? 'NEWCOUPON')) }}</div>
                            <div id="coupon-value-preview" class="coupon-preview-value">Discount preview</div>
                            <div class="coupon-meta">
                                <span id="coupon-min-preview" class="coupon-chip">Min order</span>
                                <span id="coupon-limit-preview" class="coupon-chip">Usage</span>
                                <span id="coupon-start-preview" class="coupon-chip">Starts</span>
                                <span id="coupon-expiry-preview" class="coupon-chip">Expires</span>
                            </div>
                        </div>
                    </aside>
                </div>
                ...
                <div class="coupon-actions">
                    <button type="submit" class="coupon-btn-primary">Update Coupon</button>
