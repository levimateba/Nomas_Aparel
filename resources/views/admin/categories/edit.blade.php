...
@section('content')
    ...
    <div class="category-form-wrap">
        <div class="category-form-head">
            <h2>Edit Category</h2>
            <p>Update category details and visibility to keep your catalog structure accurate.</p>
        </div>
                ...
                <div class="category-form-grid">
                    <div class="category-section-card">
                        ...
                        <div class="category-field">
                            ...
                            <input id="category-name" type="text" name="name" value="{{ old('name', $category->name) }}" maxlength="255" placeholder="e.g. Electronics" required>
                        ...
                        <div class="category-field">
                            ...
                            <input id="category-slug" type="text" name="slug" value="{{ old('slug', $category->slug) }}" placeholder="auto-generated-if-empty">
