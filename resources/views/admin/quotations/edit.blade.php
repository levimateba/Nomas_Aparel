    ...
    <div class="quotation-page">
        <section class="quotation-head">
            <div>
                ...
                <p>Update pricing, scope, or client details while keeping this quotation consistent and accurate.</p>
                @if($quotation->quote_id)
                    <p>
                        Linked to <a class="quotation-link" href="{{ route('admin.quotes.show', $quotation->quote_id) }}">Quote Request #{{ $quotation->quote_id }}</a>
                    </p>
                @endif
            </div>
        ...
        <section class="quotation-card">
            <form method="POST" action="{{ route('admin.quotations.update', $quotation) }}">
                ...
                <div class="quotation-actions">
                    @if($quotation->quote_id)
                        <a href="{{ route('admin.quotes.show', $quotation->quote_id) }}" class="quotation-btn quotation-btn-secondary">View Quote Request</a>
                    @endif
                    <button type="submit" class="quotation-btn quotation-btn-primary">Update Quotation</button>
                </div>
            </form>
        </section>
    </div>
