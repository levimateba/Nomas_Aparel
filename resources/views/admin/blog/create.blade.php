...
@section('subheading', 'Dashboard › Blog › Create')
...
/* Override blog field/input styles from _form partial */
.blog-input {
...
<div class="bp-page">
    ...
    <div class="bp-card">
        <div class="bp-card-head">
            ...
            <div class="bp-card-sub">Enter title, content, media, and publishing options for this article.</div>
        </div>
    ...
    <div class="bp-preview-panel">
        <div class="bp-preview">
            ...
            <div class="bp-preview-body">
                <span id="blog-publish-badge" class="bp-badge live">Published</span>
                ...
                <h4 id="blog-title-preview" class="bp-prev-title">Post title preview</h4>
                <p id="blog-meta-preview" class="bp-prev-meta">By {{ auth()->user()?->name ?? 'Author' }} | Uncategorized</p>
                <p id="blog-excerpt-preview" class="bp-prev-excerpt">Your short summary will appear here.</p>
                <div class="bp-chips">
                    <span id="blog-content-count" class="bp-chip">Content: 0 chars</span>
                    <span id="blog-excerpt-count" class="bp-chip">Excerpt: 0 chars</span>
                </div>
            </div>
        </div>
    </div>
