...
<aside id="sidebar"
    class="fixed inset-y-0 start-0 z-99999 flex h-screen w-[90px] flex-col border-r border-white/5 bg-[#1C2434] px-5 text-gray-100 transition-all duration-300 ease-in-out [.sidebar-expanded_&]:min-w-[290px]"
    x-data="{
        open: {
    ...
    :class="{
        ...
        'max-xl:-translate-x-full': !$store.sidebar.isMobileOpen
    }"
    @mouseenter="if (!$store.sidebar.isExpanded) $store.sidebar.setHovered(true)"
    @mouseleave="$store.sidebar.setHovered(false)">

    <div class="flex items-center gap-2 pb-7 pt-8"
        :class="(!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen) ? 'justify-center' : 'justify-between'">
    ...
    <div class="no-scrollbar flex flex-1 flex-col overflow-y-auto duration-300 ease-linear">
                        ...
                        <li>
                            <a href="{{ route('admin.dashboard') }}"
                               class="menu-item group {{ request()->routeIs('admin.dashboard') ? 'menu-item-active' : 'menu-item-inactive' }}">
                                ...
                                <span class="menu-item-text" x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen">Dashboard</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{ route('admin.cashier.home') }}"
                               class="menu-item group {{ request()->routeIs('admin.cashier.home') ? 'menu-item-active' : 'menu-item-inactive' }}">
                                ...
                                <span class="menu-item-text" x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen">Cashier Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.pos.index') }}"
                               class="menu-item group {{ request()->routeIs('admin.pos.index') && ! request()->routeIs('admin.pos.scan') ? 'menu-item-active' : 'menu-item-inactive' }}">
                                ...
                                <span class="menu-item-text flex items-center gap-2" x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen">
                        ...
                        <li>
                            <a href="{{ route('admin.pos.scan') }}"
                               class="menu-item group {{ request()->routeIs('admin.pos.scan') ? 'menu-item-active' : 'menu-item-inactive' }}">
                                ...
                                <span class="menu-item-text" x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen">Scan &amp; Sell</span>
                            </a>
                        </li>
                        @endif
                    </ul>
        ...
        <div class="mt-auto mb-6 space-y-3" x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen">
